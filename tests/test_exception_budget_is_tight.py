...
def _evaluate(per_file, bare=(), silent=()):
    return CHECK['evaluate'](per_file, list(bare), list(silent), BUDGET, LIMIT,
...
def test_the_budget_matches_the_tree():
    ...
    per_file, bare, silent = CHECK['measure']()
    problems = CHECK['evaluate'](per_file, bare, silent, BUDGET, LIMIT, TOTAL)
...
def test_the_measurement_finds_something_to_measure():
    ...
    per_file, _bare, _silent = CHECK['measure']()
