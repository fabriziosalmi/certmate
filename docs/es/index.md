...
Los recuentos por area que habia aqui describian una suite de 27 pruebas. Ejecute el comando anterior para la cifra actual, o consulte las insignias del [README del proyecto](../../README.md).
